Building MSI:
The installed package contains setup.cs file which you should use instead of the default program.cs, which you can remove from the project.
...
If you want to examine generated WiX project source file set Compiler.PreserveTempFiles to true just before calling Compiler.BuildMsi.
...
WixSharp suite contains WIX (v3.5.2519.0) as well as the set of samples for all major deployment scenarios. 